...
export default class TopRated extends Component {
  ...
  mostrarMasPeliculas(){
    fetch(`https://api.themoviedb.org/3/movie/top_rated?page=${this.state.page + 1}`, options)
    .then(resp => resp.json())
    .then(data => this.setState({
  ...
  render() {
    return (
      ...
      <Form categoria="Top Rated" filtrarPeliculas={(busqueda)=> this.filtrarPeliculas(busqueda)}/>
